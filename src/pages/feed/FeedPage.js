...
// import { goToInactiveStudent } from "../../routes/cordinator";
...
//           <div
//             key={student.id}
//             className="flex flex-col gap-8 m-2 text-center items-center justify-self-center align-middle justify-center  p-2 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-100 w-80 h-40"
//           >
//             <div className="text-lg">{student.name}</div>

//             <a href={`/goToStudent/${student.id}`} className="text-blue-500">
//               Ver mais
//             </a>
//           </div>
//         ))}
...
import { useRequestData } from "../../hooks/useRequestData";
import { BASE_URL } from "../../constants/baseURL";
import { Link, Navigate, useNavigate } from "react-router-dom"; // Importe Link para navegação interna
